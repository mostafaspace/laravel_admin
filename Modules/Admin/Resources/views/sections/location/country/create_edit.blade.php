                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" class="form-control" maxlength="255" placeholder="Name" value="@if(isset($country)){{$country->translate($current_lang, true)->name}}@else{{old('name')}}@endif">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="code" class="form-control" maxlength="255" placeholder="Code" value="@if(isset($country)){{trim($country->code)}}@else{{old('code')}}@endif">
                                        @if ($errors->has('code'))
