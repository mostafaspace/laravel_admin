                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('role') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <?php $selected_role = isset($user) && $user ? (isset($select_role) ? $select_role->role_id : '') : old('role'); ?>
                                ...
                                <div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <?php $selected_country = isset($user) && $user ? $user->country_id : old('country'); ?>
                                ...
                                <div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <?php $selected_city = isset($user) && $user ? $user->city_id : old('city'); ?>
