                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">@if(isset($category)) Edit {{$category->name}} @else Add New Category @endif</span>
                        </div> 
                    </div>
                    ...
                    <?php 
                        ...
                        $nameVal = (isset($category)) ? (Request::route()->getName()!='admin.category.add.get' ? $category->translate($current_lang, true)->name : old('name')) : old('name'); 
                        $slugVal = isset($category) ? $category->slug : old('slug');
                    ?>
                    <form  class="form-horizontal" method="post" enctype="multipart/form-data" action="@if(isset($action) && $action == 'edit'){{ route('admin.category.edit.post', $category->id) }} @else  {{ route('admin.category.add.post', $get_parameters) }} @endif">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group {{ $errors->has('parent') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        ...
                                        @if(isset($categories))
                                            ...
                                            <option value="{{$cat->category_id}}" @if(isset($category)) @if($cat->category_id == $category->parent) selected @endif @endif>{{$cat->name}}</option>
                                            @endforeach
                                        @endif 
                                        </select>
                                ...
                                <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="description" id="description"class="form-control">@if(isset($category)){{$category->translate($current_lang, true)->description}}@else{{ old('description')}}@endif</textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="submit" class="btn blue" value="@if(isset($category)) Edit @else Add New Category @endif">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
