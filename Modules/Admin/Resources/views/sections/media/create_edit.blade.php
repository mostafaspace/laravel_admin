        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="@if(isset($media)){{ route('admin.media.edit.post', $media->id) }} @else {{ route('admin.media.add.post') }} @endif" class="dropzone dropzone-file-area" id="my-dropzone" style="margin-top: 10px;">
