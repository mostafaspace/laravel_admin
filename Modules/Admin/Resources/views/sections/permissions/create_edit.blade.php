                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="description" class="form-control" maxlength="255" placeholder="Description" value="@if(isset($permission)){{trim($permission->description)}}@else{{old('description')}}@endif">
                                ...
                                <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="category" class="form-control" maxlength="255" placeholder="Description" value="@if(isset($permission)){{trim($permission->category)}}@else{{old('category')}}@endif">
                                ...
                                {{--<div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">--}}
                                    ...
                                    {{--<div class="col-md-5">--}}
                                        {{--<select class="form-control" name="category" required>--}}
                                            ...
                                            {{--<option value="comment" @if(isset($permission)) @if($permission->category == 'comment') selected @endif @endif>Comments</option>--}}
                                            {{--<option value="user" @if(isset($permission)) @if($permission->category == 'user') selected @endif @endif>User</option>--}}
