...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title> @if ($__env->yieldContent('title')) @yield('title') | Dashboard @else Dashboard @endif </title>
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="{{ route('admin.home.get') }}">
                        {{--<img src="{{ asset('public/assets/admin/layouts/layout4/img/logo-light.png') }}" alt="logo" class="logo-default" />--}}
                        <h2>Laravel CMS</h2>
                    </a>
