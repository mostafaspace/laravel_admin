<?php
Route::group(['middleware' => ['web', 'roles'],'roles' => 'admin', 'prefix' => 'admin', 'namespace' => 'Modules\Admin\Http\Controllers'], function(){
	...
	*/
	Route::group(['prefix' => 'posts'], function() {
		Route::get( '/',					[ 'as' => 'admin.posts.get', 					'uses' => 'PostController@getPost'  	  				]);
...
//		Route::get( '/delete/{id}',			[ 'as' => 'admin.media.delete.get', 			'uses' => 'MediaController@getDeleteMedia'  			]);
		...
		Route::post( '/getMediaAjax',		[ 'as' => 'admin.media.ajax.post', 				'uses' => 'MediaController@getMediaAjax'  				]);
	});
	...
	*/
	Route::group(['prefix' => 'comments'], function() {
		...
		Route::get( '/add-new',				[ 'as' => 'admin.comments.add.get', 			'uses' => 'CommentController@getAddComment'   			]);
		Route::post( '/add-new',			[ 'as' => 'admin.comments.add.post', 			'uses' => 'CommentController@postAddComment'   			]);
		Route::get( '/edit/{id}',			[ 'as' => 'admin.comments.edit.get', 			'uses' => 'CommentController@getEditComment'   			]);
		Route::post( '/edit/{id}',			[ 'as' => 'admin.comments.edit.post', 			'uses' => 'CommentController@postEditComment'   		]);
		Route::get( '/data',				[ 'as' => 'admin.comments.data.get', 			'uses' => 'CommentController@getCommentData' 			]);
		Route::get( '/delete/{id}',			[ 'as' => 'admin.comments.delete.get', 			'uses' => 'CommentController@getDeleteComment'  		]);
		Route::post( '/delete/{id}',		[ 'as' => 'admin.comments.delete.post', 		'uses' => 'CommentController@postDeleteComment'  		]);
	});
